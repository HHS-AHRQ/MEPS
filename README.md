...
MEPS is a set of large-scale surveys of families and individuals and their medical providers, and employers across the United States, conducted annually since 1996. MEPS is the only national data source that measures how Americans use and pay for medical care, health insurance, and out-of-pocket spending. Annual surveys of individuals and families, as well as their health care providers, provide data on health status, the use of medical services, charges, insurance coverage, and satisfaction with care. More information on each component is provided below.
